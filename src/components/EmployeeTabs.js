...
function EmployeeTabs() {
  ...
  const deleteEmployee = async() => {
    ...
    const promise = fetch(`http://localhost:5003/roster/delete?id=${selected}`); 
  ...
  const updateEmployee = async() => {
    ...
    const promise = fetch(`http://localhost:5003/roster/update_type?id=${selected}&manager=${changeType}`); 
    const response = await promise;
  }
  ...
  const queryRosterSummary = async() => {
    const promise = fetch(`http://localhost:5003/roster/summary`); 
    const response = await promise;
  ...
  const addEmployee = async() => {
    const firstPromise = fetch(`http://localhost:5003/roster/nextID`); 
    ...
    const promise = fetch(`http://localhost:5003/roster/add?id=${result.nextID}&name=${userInput}&manager=${type}`); 
    const response = await promise;
    setUserInput("");
    setType(0);
