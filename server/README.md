...
Ex: http://localhost:5002/inventory?id=3
...
Ex: http://localhost:5002/inventory?name=black_pepper_angus_steak
Ex Response: {"item_id":3,"item_name":"black_pepper_angus_steak","servings":"12.00","restock_quantity":300,"item_price":"4.02","food_type":"entree","minimum_amount":50}
...
Ex: http://localhost:5002/inventory/add?id21=&name=testname&servings=10&restock_quantity=30&price=3.21&food_type=entree&minimum_amount=50
Ex Response: No response

#### Remove Item From Inventory
Route: /innentory/delete?id={item_id}
Ex: http://localhost:5002/inventory/delete?id=22
Ex Response: No response

#### Subtract Servings From Item
Route: /inventory/subtract?id={id}&servings={number of servings}
Ex: http://localhost:5002/inventory/subtract?id=3&servings=1
Ex Response: No response

#### Update Servings For Item
Route: /inventory/update_servings?id={id}&servings={number of servings}
Ex: http://localhost:5002/inventory/update_servings?id=3&servings=12
Ex Response: No response

#### Update Price For Item
Route: /inventory/update_price?id={id}&price={new price}
Ex: http://localhost:5002/inventory/update_price?id=3&price=4.01
Ex Response: No response

#### Get Full Inventory
Route: /inventory/summary
Ex: http://localhost:5002/inventory/summary
...
Ex: http://localhost:5002/inventory/nextID
Ex Response: {"nextID":22}

#### Restock Full Inventory
Route: /inventory/restock
Ex: http://localhost:5002/inventory/restock
Ex Response: No response


#### Restock Critical Inventory
Route: /inventory/critical_restock
Ex: http://localhost:5002/inventory/critical_restock
Ex Response: No response

#### Get Seasonal Items
Route: /inventory/seasonal_items
Ex: http://localhost:5002/inventory/seasonal_items
...
Ex: http://localhost:5002/order_history?id=3
...
Ex: http://localhost:5002/order_history/nextID
Ex Response: {"nextID":5538}

#### Get Full Order History
Route: /order_history/summary
Ex: http://localhost:5002/order_history/summary
Ex Response: \[{"transaction_id":3,"employee_id":1,"date":"2022-10-01T05:00:00.000Z","type_of_dish":"bigger plate","entree_dish":"honey_seasame_chicken,orange_chicken","entree_amt_servings":"2,4","side_ingredients":"brown_steamed_rice","side_amt_servings":5,"appetizer_ingredients":"chicken_egg_roll","appetizer_amt_servings":1,"price":"13.203985300"},...\]
...
Ex: http://localhost:5002/roster/add?id=3&name=Jackie%20Wells&manager=0
Ex Response: No response

#### Get Next Available Employee ID
Route: /roster/nextID
Ex: http://localhost:5002/roster/nextID
...
Ex: http://localhost:5002/roster/update_type?id=4&manager=1
Ex Response: No Response
...
Ex: http://localhost:5002/authorized_emails/summary
Ex Response: [{"email":"alex.m.deyoung@tamu.edu"},{"email":"casazzan@tamu.edu"},...]

#### Add email
Route: /authorized_emails/add?email={email}
Ex: http://localhost:5002/authorized_emails/add?email={email}
Ex Response: No Response